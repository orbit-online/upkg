...
```
wget -qO- https://raw.githubusercontent.com/orbit-online/upkg/v0.9.5/upkg.sh | (
  IFS='' read -r -d $'\0' src; set -e
  printf '%s' "$src" | shasum -a 256 -c <(printf '0756c474add07776aea946975b9b86a8db33bf9e792d64e96128a54fccf7a2d7  -')
  bash -c "set - install -g orbit-online/upkg@v0.9.5; $src")
```
